...
@Component({
  selector: 'app-marki-avto-select',
  templateUrl: './marki-avto-select.component.html',
  styleUrls: ['./marki-avto-select.component.css']
})
export class MarkiAvtoSelectComponent implements OnInit {
  ...
  onSelected(marki_avto:marki_avto_element) {
    if (!this.selected) {
    this.messageServiceadd.add({ severity: 'error', summary: 'Ошибка', detail: 'Выберите марки авто!' })
    return
    }
